...
//header
    class MyPDF extends TCPDF{
		...
		// Title
		$this->Cell(0, 15, 'Datos de Turnos', 0, false, 'C', 0, '', 0, false, 'T', 'C');
	    }
    ...
    [$datos_turnos, $columnas] = selectAllServicios($conn);

    //Con eso empezamos a crear el html
    $html = '
        <table cellspacing="0" cellpadding="4" border="1"><thead><tr>';
