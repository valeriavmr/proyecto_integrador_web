...
<head>
    ...
    <title>Trazabilidad de Insumos</title>
...
<body>
    ...
    <main>
        ...
        <section id="menu_gestion">
            <article class="opc_menu_ap"><a href="<?php echo BASE_URL; ?>/php/gestor_inventario/lista_trazabilidad_insumos.php">
                <img src="../../recursos/img/buscar_insumo_icon.png" alt=""> Lista de movimientos de insumos</a></article>
            <article class="opc_menu_ap"><a href="<?php echo BASE_URL; ?>/php/gestor_inventario/trazabilidad_un_insumo.php">
